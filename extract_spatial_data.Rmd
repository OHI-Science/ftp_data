...
You will also need to [download a zip file]() that includes a region shapefile ("shapefile") and a raster describing sea surface temperature (sst_anoms_2012.tif).

```{r setup,message=F,warning=F}

file.copy("shapefile",
"../../shares/web/data/htdocs/data/shapefile")

file.copy("sst_anoms_2012.tif",
"../../shares/web/data/htdocs/data/sst_anoms_2012.tif")


## bundle and move region data to ftp site to make it easier to access
