...
We provide links to some of the large (typically spatial data), intermediate files we use to obtain the data layers that are used to calculate Ocean Health Index scores.  Specifically, you can find the following data at this site:

* Spatial files describing the regions
...
The raster data (pressures and some of the supplementary files) can be extracted at different spatial scales, which may be useful for regional OHI assessments or other types of analyses. 

A tutorial [is available](https://rawgit.com/OHI-Science/ftp_data/master/extract_spatial_data.html) that describes how to extract and summarize raster data to different regions.

Further resources are available for viewing, analzying, and manipulating spatial data in R from our [Github repository](https://github.com/eco-data-science/), specifically:
...
## Where to find other data of potential interest

The data layers we used to calculate the Ocean Health Index scores for the 220 regions are available from https://github.com/OHI-Science/ohi-global ([data files are located in the layers folders located within each scenario (e.g., eez2016)](https://github.com/OHI-Science/ohi-global)). 

In most cases, the intermediate files that we used to calculate the data layers are available from Github (https://github.com/OHI-Science/ohiprep). 
